...
namespace Magicolo.GeneralTools {
	...
	public class ComboSystemEditor : CustomEditorBase {
		...
		void ShowComboEnums() {
			...
			comboManagerProperty.FindPropertyRelative("inputEnumTypeName").SetValue(ComboEnumTypeDict[comboManagerProperty.FindPropertyRelative("inputEnumName").GetValue<string>()].FullName);
