	...
	public class StateMachineGeneratorWindow : CustomWindowBase {
		...
		void GenerateStates() {
			...
			foreach (string state in states) {
				...
				string formattedInherit = StateMachineEditor.FormatLayer(inherit);
				if (StateMachineEditor.LayerStateNameDict.ContainsKey(formattedInherit) && StateMachineEditor.LayerStateNameDict[formattedInherit].Contains(state)) {
